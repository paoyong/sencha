...
/******/ 	__webpack_require__.p = "http://localhost:9090/assets/";
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReplyBox = __webpack_require__(7);
	var UpvoteButton = __webpack_require__(8);
	var PointsBanner = __webpack_require__(9);
	var React = __webpack_require__(4);

	var CommentThreadApp = React.createClass({displayName: "CommentThreadApp",
	    ...
	    render: function() {
	        ...
	        if (this.state.post) {
	            ...
	            PostComponent = React.createElement(Post, React.__spread({},  PostProps))
	        }

	        return (
	            React.createElement("div", {className: "comment-thread-app"}, 
	                PostComponent, 
	                React.createElement("h3", null, commentCount, " comments"), 
	                React.createElement(CommentForm, {
	                    onCommentSubmit: this.handleReply}
	                ), 
	                React.createElement(CommentThread, React.__spread({},  CommentThreadProps))
	            )
	        );
	    }
	});
	...
	var CommentForm = React.createClass({displayName: "CommentForm",
	    ...
	    render: function() {
	        return (
	            React.createElement("form", {className: "new-comment-form", onSubmit: this.handleSubmit}, 
	                React.createElement("textarea", {type: "text", ref: "message", maxLength: "300", placeholder: "Reply to thread...", className: "thread-reply-textarea"}), 
	...
	var CommentThread = React.createClass({displayName: "CommentThread",
	    ...
	    render: function() {
	        ...
	        var comments = this.props.comments.map(function(comment) {
	            ...
	            return (
	                React.createElement(Comment, React.__spread({},  CommentProps))
	            );
	        });

	        return (
	            React.createElement("ul", {className: "comment-thread"}, 
	                comments
	            )
	        );
	    }
	...
	React.render(
	    React.createElement(CommentThreadApp, {
	        url: commentsGETURL, 
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Remarkable = __webpack_require__(34);
	    ...
	    render: function() {
	        ...
	        return (
	            React.createElement("li", {className: className}, 
	                React.createElement(CommentTopBanner, {
	                ...
	                React.createElement(CommentBottomBanner, {
	                    upvoted: comment.upvoted, 
	...
	var CommentMessage = React.createClass({displayName: "CommentMessage",
	    propTypes: {
	        message: React.PropTypes.string
	    },
	    render: function() {
	        ...
	        return React.createElement("span", {className: "comment-message", dangerouslySetInnerHTML: {__html: rawMarkup}})

	    }
	});

	var CommentTopBanner = React.createClass({displayName: "CommentTopBanner",
	    propTypes: {
	    ...
	    render: function() {
	        ...
	        return (
	            React.createElement("p", {className: "comment-top-banner"}, 
	                React.createElement("a", {href: authorHref, className: "comment-author"}, this.props.author), 
	                React.createElement("span", {className: "comment-score"}, 
	                    React.createElement(PointsBanner, {
	                        preText: " • ", 
	                        postText: " ", 
	                ...
	                React.createElement("span", {className: "comment-age"}, ageString, " ago ")
	            )
	        );
	    }
	});

	var CommentBottomBanner = React.createClass({displayName: "CommentBottomBanner",
	    propTypes: {
	        upvoted: React.PropTypes.bool.isRequired,
	        handleUpvote: React.PropTypes.func.isRequired,
	        handleRemoveUpvote: React.PropTypes.func.isRequired,
	    ...
	    render: function() {
	        ...
	        return (
	            React.createElement("p", {className: "comment-bottom-banner"}, 
	                React.createElement(UpvoteButton, React.__spread({},  UpvoteButtonProps)), ' ', 
	                React.createElement(ReplyBox, {onReply: this.handleReply, defaultClassName: "reply-box"})
	            )
	        );
	    }
	});
...
/***/ function(module, exports, __webpack_require__) {
	    ...
	    render: function() {
	        ...
	        return (
	            React.createElement("li", {className: "post"}, 
	                React.createElement(UpvoteButton, React.__spread({},  UpvoteButtonProps)), 
	                React.createElement(PostTitle, {post: post, commentsURL: this.props.commentsURL}), " ", React.createElement("br", null), 
	                React.createElement(PostInfoBanner, React.__spread({},  PostInfoBannerProps))
	            )
	        );
	    }
	});
	...
	var PostTitle = React.createClass({displayName: "PostTitle",
	    render: function() {
	        ...
	        return (
	            React.createElement("a", {href: postURL, className: "post-title"}, post.title)
	        );
	    }
	});

	var PostInfoBanner = React.createClass({displayName: "PostInfoBanner",
	    render: function() {
	        ...
	        return (
	            React.createElement("div", {className: "post-info-banner"}, 
	                React.createElement("p", null, 
	                    ...
	                    " • Submitted by ", React.createElement("a", {href: authorURL, className: "post-author"}, this.props.author), " ", React.createElement("span", {className: "post-age"}, bannerAge), " ago • ", React.createElement("a", {href: this.props.commentsURL}, commentString)
	                )
	            )
	        );
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReplyBox = React.createClass({displayName: "ReplyBox",
	    ...
	    render: function() {
	        ...
	        return (
	            React.createElement("span", {className: this.props.defaultClassName}, 
	                React.createElement(ReplyButton, React.__spread({},   ReplyButtonProps))
	            )
	        );
	    }
	});
	        ...
	        if (this.state.isSubmitting) {
	            textareaComponent = (
	                React.createElement("div", null, 
	                    React.createElement("textarea", {className: this.props.defaultClassName + "-textarea", ref: "textArea"})
	                )
	            );
	            ...
	            cancelButtonComponent = (
	                React.createElement("span", null, 
	                    ' • ', 
	                    React.createElement("a", {className: this.props.defaultClassName + "-cancel-button", onClick: this.cancel}, "cancel")
	                )
	            );
	        }

	        return (
	            React.createElement("span", {className: this.props.defaultClassName + "-banner"}, 
	                textareaComponent, 
	                React.createElement("a", {className: this.props.defaultClassName + "-reply-button", onClick: this.getOnClickFunction()}, "reply"), 
	                cancelButtonComponent
	            )
	        );
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var UpvoteButton = React.createClass({displayName: "UpvoteButton",
	    propTypes: {
	        upvoted            : React.PropTypes.bool.isRequired,
	    ...
	    render: function() {
	        ...
	        return (
	            React.createElement("div", {className: this.props.defaultClassName + "-wrapper", style: wrapperStyle}, 
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PointsBanner = React.createClass({displayName: "PointsBanner",
	    propTypes: {
	    ...
	    render: function() {
	        ...
	        return (
	            React.createElement("span", {className: postPointsClassname}, this.props.preText, this.props.score, " ", formattedPointsText, this.props.postText)
	        );
	    }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	    ...
	    getCommentCountString: function(numComments) {
	        var commentString = '';
	    ...
	    findAndUpdateUpvoted: function(currArr, targetId, isUpvoting) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactServerRendering = __webpack_require__(29);

	var assign = __webpack_require__(30);
	var findDOMNode = __webpack_require__(31);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var assign = __webpack_require__(30);
	var invariant = __webpack_require__(41);
	var keyMirror = __webpack_require__(95);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var assign       = __webpack_require__(144).assign;
	var Renderer     = __webpack_require__(145);
	var ParserCore   = __webpack_require__(146);
	var ParserBlock  = __webpack_require__(147);
	var ParserInline = __webpack_require__(148);
	var Ruler        = __webpack_require__(149);
	...
	var config = {
	  'default':    __webpack_require__(150),
	  'full':       __webpack_require__(151),
	  'commonmark': __webpack_require__(152)
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var forEachAccumulated = __webpack_require__(161);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var rules = __webpack_require__(180);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _rules = [
	  ...
	  [ 'abbr',           __webpack_require__(172)           ],
	  [ 'references',     __webpack_require__(173)     ],
	  [ 'inline',         __webpack_require__(174)         ],
	  [ 'footnote_tail',  __webpack_require__(175)  ],
	  [ 'abbr2',          __webpack_require__(176)          ],
	  [ 'replacements',   __webpack_require__(177)   ],
	  [ 'smartquotes',    __webpack_require__(178)    ],
	  [ 'linkify',        __webpack_require__(179)        ]
	];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Ruler      = __webpack_require__(149);
	var StateBlock = __webpack_require__(181);
	...
	var _rules = [
	  [ 'code',       __webpack_require__(182) ],
	  [ 'fences',     __webpack_require__(183),     [ 'paragraph', 'blockquote', 'list' ] ],
	  [ 'blockquote', __webpack_require__(184), [ 'paragraph', 'blockquote', 'list' ] ],
	  [ 'hr',         __webpack_require__(185),         [ 'paragraph', 'blockquote', 'list' ] ],
	  [ 'list',       __webpack_require__(186),       [ 'paragraph', 'blockquote' ] ],
	  [ 'footnote',   __webpack_require__(187),   [ 'paragraph' ] ],
	  [ 'heading',    __webpack_require__(188),    [ 'paragraph', 'blockquote' ] ],
	  [ 'lheading',   __webpack_require__(189) ],
	  [ 'htmlblock',  __webpack_require__(190),  [ 'paragraph', 'blockquote' ] ],
	  [ 'table',      __webpack_require__(191),      [ 'paragraph' ] ],
	  [ 'deflist',    __webpack_require__(192),    [ 'paragraph' ] ],
	  [ 'paragraph',  __webpack_require__(193) ]
	];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Ruler       = __webpack_require__(149);
	var StateInline = __webpack_require__(194);
	var utils       = __webpack_require__(144);
	...
	var _rules = [
	  ...
	  [ 'newline',         __webpack_require__(196) ],
	  [ 'escape',          __webpack_require__(197) ],
	  [ 'backticks',       __webpack_require__(198) ],
	  [ 'del',             __webpack_require__(199) ],
	  [ 'ins',             __webpack_require__(200) ],
	  [ 'mark',            __webpack_require__(201) ],
	  [ 'emphasis',        __webpack_require__(202) ],
	  [ 'sub',             __webpack_require__(203) ],
	  [ 'sup',             __webpack_require__(204) ],
	  [ 'links',           __webpack_require__(205) ],
	  [ 'footnote_inline', __webpack_require__(206) ],
	  [ 'footnote_ref',    __webpack_require__(207) ],
	  [ 'autolink',        __webpack_require__(208) ],
	  [ 'htmltag',         __webpack_require__(209) ],
	  [ 'entity',          __webpack_require__(210) ]
	];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var StateInline    = __webpack_require__(194);
	var parseLinkLabel = __webpack_require__(217);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var StateInline          = __webpack_require__(194);
	var parseLinkLabel       = __webpack_require__(217);
	var parseLinkDestination = __webpack_require__(218);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var has             = __webpack_require__(144).has;
	var unescapeMd      = __webpack_require__(144).unescapeMd;
	var replaceEntities = __webpack_require__(144).replaceEntities;
	var escapeHtml      = __webpack_require__(144).escapeHtml;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var block_names = __webpack_require__(221);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var url_schemas   = __webpack_require__(222);
	var normalizeLink = __webpack_require__(223);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var HTML_TAG_RE = __webpack_require__(224).HTML_TAG_RE;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var entities          = __webpack_require__(170);
	var has               = __webpack_require__(144).has;
	var isValidEntityCode = __webpack_require__(144).isValidEntityCode;
	var fromCodePoint     = __webpack_require__(144).fromCodePoint;
