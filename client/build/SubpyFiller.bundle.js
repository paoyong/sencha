...
/***/ function(module, exports, __webpack_require__) {
	...
	var App = React.createClass({displayName: "App",
	    ...
	    render: function() {
	        return (
	            React.createElement("ul", {className: "subpys-list-app"}, 
	                React.createElement(SubpysList, {subpys: this.state.subpys})
	            )
	        );
	    }
	});

	var SubpysList = React.createClass({displayName: "SubpysList",
	    render: function() {
	        var subpys = this.props.subpys.map(function(subpy) {
	            return (
	                React.createElement(Subpy, {subpy: subpy.name})
	            );
	        })

	        return (
	            React.createElement("ul", {className: "subpys-list"}, 
	                subpys
	            )
	        );
	    }
	...
	var Subpy = React.createClass({displayName: "Subpy",
	    render: function() {
	        var subpy = this.props.subpy;
	        var link = '/r/' + subpy;

	        return (
	            React.createElement("li", {className: "subpy-list-item"}, 
	                React.createElement("a", {href: link}, subpy)
	            )
	        );
	    }
	})
	...
	React.render(
	    React.createElement(App, {url: defaultURL}),
